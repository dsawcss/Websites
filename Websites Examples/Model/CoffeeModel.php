...
class CoffeeModel {
	...
	///Get all coffee distinct types from the database and return them in an array for dropdown list selection
	function GetCoffeeTypes() { 
		...
		$sql = "SELECT DISTINCT type FROM coffee"; // type = HeaderName, coffee = database table
	...
	//Data retrieved will be for coffee table in coffee webpage
	function GetCoffeeByType($type)	{ // $type = coffee entity
		require ('Credentials.php');
		//Open connection and Select database.
		$conn = mysqli_connect($host, $user, $passwd, $database);
		if($conn->connect_error)	{
		...
		// type = HeaderName, $type = coffee entity, coffee = database table
	...
	function GetCoffeeById($id)	{ //for management webpage
		require ('Credentials.php');
		//Open connection and Select database.
		$conn = mysqli_connect($host, $user, $passwd, $database);
		if($conn->connect_error)	{
