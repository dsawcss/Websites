...
class CoffeeController {
    ...
    function CreateOverviewTable() { //overview table in Coffee Overview link in management webpage 
        $result = "
    ...
    function CreateCoffeeDropdownList() { //dropdown list in index coffee webpage
    ...
    function CreateCoffeeTables($types) { //coffee tables in coffee webpage
        $coffeeModel = new CoffeeModel();
    ...
    //Returns list of image files in a folder.
    function GetImages() {
